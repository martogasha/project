                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('registered')}}">
                                <i class="ri-honour-line"></i> <span data-key="t-widgets">Registered institutions</span>
                            </a>
                        </li>
                         <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('bandwidth')}}">
                                <i class="ri-honour-line"></i> <span data-key="t-widgets" style="color:white;">Bandwidth</span>
                            </a>
                        </li>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Bandwidth Per Month</h4>
                    ...
                    <!-- end page title -->
                        <div class="col-12">
                            <a href="{{URL('Addbandwidth')}}"><button class="btn btn-primary" type="submit">Add Bandwidth</button></a>
                                            ...
                                            <table class="table align-middle table-nowrap table-striped-columns mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$bandwidth->amount}}</td>
                                                        <td>
                                                            <a href="{{url('editbandwidth',$bandwidth->id)}}"><button type="button" class="btn btn-sm btn-light">Edit</button></a>
                                                            <a href="{{url('deleteBandwith',$bandwidth->id)}}"><button type="button" class="btn btn-sm btn-danger">Delete</button></a>
                                                        </td>
                                                    </tr>
                                              @endforeach
                                                </tbody>
