            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Register Institution</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                            <form action="{{url('storeInstitution')}}" method="post">
                                        @csrf
                                <div class="card-body">
                                        ...
                                        <div class="row gy-4">
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" name="institution_name" class="form-control" id="basiInput">
                                                </div>
                                            </div>
                                             <div class="col-xxl-3 col-md-6">
                                                <div>
                                            ...
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" name="No_of_computers" class="form-control" id="valueInput">
                                                </div>
                                            </div>
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    <label for="valueInput" class="form-label">Local Area Network(LAN) Nodes</label>
                                                    <input type="text" name="lan_nodes" class="form-control">
                                                </div>
                                            </div>
