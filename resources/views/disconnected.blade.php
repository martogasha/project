...
<head>
    ...
    <meta charset="utf-8" />
    <title>Disconnected Institutions</title>
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url('disconnected')}}">
                                <i class="ri-honour-line"></i> <span data-key="t-widgets" style="color:white;">Disconnected Institutions</span>
                            </a>
                        </li>
                         <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">DISCONNECTED INSTITUTIONS</h4>
