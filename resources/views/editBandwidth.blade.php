                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Edit Bandwidth</h4>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                        <form action="{{url('eBandwidth',$band->id)}}" method="post">
                                        @csrf
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-xxl-3 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" name="amount" class="form-control" value="{{$band->amount}}">
                                                </div>
                                            </div>
                                            <!--end col-->
